...
import {sortOpt, statusOpt, typeOpt} from '../contants/index'
...
// sayac baslat işlemi sayac durunca yap
  const timer = setTimeout(() => setDebouncedText(text), 2000);
// eğerki süre bitmeden tekrr useeffect çalışırsa önceki sayacı iptal et 
    return () => {
      clearTimeout(timer);
    };
